package com.zq.ability.analyse
...
import com.zq.ability.push.PushConstants
import com.zq.ability.push.SimpleLifecycleCallbacks

internal object AnalyseUtil {

    fun init(application: Application, channel: String) {
        UMConfigure.preInit(application, PushConstants.APP_KEY, channel)
