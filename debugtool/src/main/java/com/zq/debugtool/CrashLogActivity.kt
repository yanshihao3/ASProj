...
import com.zq.hilibrary.crash.CrashMgr
import java.io.File
...
class CrashLogActivity : BaseActivity() {
    ...
    inner class CrashLogAdapter(val crashFiles: Array<File>) :
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            holder.itemView.findViewById<TextView>(R.id.file_title).text = file.name
            holder.itemView.findViewById<TextView>(R.id.file_share).setOnClickListener {
